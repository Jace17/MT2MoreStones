...
| Backstone+        | Spell | Banished        | Uncommon | Add Retreat. Ember cost -1. (Targeted spells only.)    |
| Cloudslab         | Unit  | Banished        | Uncommon | Add Shift: +4 Attack, +4 Health                        |
...
| Upstone+          | Spell | Hellhorned      | Uncommon | Add Ascend. Ember cost -1. (Targeted spells only.)     |
| Artislab          | Unit  | Lazarus League  | Rare     | Add Artificer: +12 Attack, +12 Health                  |
...
| Formstone+        | Spell | Melting Remnant | Uncommon | Reform a random unit.                                  |
| Scourstone (Same) | Spell | Melting Remnant | Rare     | Remove all buff effects from enemy units.              |
...
| Downstone+        | Spell | Umbra           | Uncommon | Add Descend. Ember cost -1. (Targeted spells only.)    |
...
| Frontstone+       | Spell | Underlegion     | Uncommon | Add Advance. Ember cost -1. (Targeted spells only.)    |
