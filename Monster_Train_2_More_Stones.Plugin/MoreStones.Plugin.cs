...
namespace Monster_Train_2_More_Stones.Plugin
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            addBoomstone = Config.Bind("General", "Boomstone", true, "Enable Boomstone. (Add Explosive. Spell Power +20.)\n启用爆破石（法术获得爆炸，+20 魔法强度。）");
            ...
            addShellstone = Config.Bind("General", "Shellstone", true, "Enable Shellstone. (Add Titanskin 3.)\n启用甲壳石（单位获得泰坦皮肤 3。）");
            addTramplestone = Config.Bind("General", "Tramplestone", true, "Enable Stompstone. (Add Trample.)\n启用蹂躏石（单位获得践踏。）");
            addSwipestone = Config.Bind("General", "Swipestone", true, "Enable Swipestone. (Add Sweep. Attack -20.)\n启用拍击石（单位获得横扫，-20 攻击力。）");
            addTrainstone = Config.Bind("General", "Trainstone", true, "Enable Trainstone. (Ember cost is 0.)\n启用火车石（单位费用变成 0 余烬。）");
            addPiercestone = Config.Bind("General", "Piercestone", true, "Enable Truestone. (Add Piercing. Spell Power +10.)\n启用真言石（法术获得穿刺，+10 魔法强度。）");
            ...
            addSmokestone = Config.Bind("General", "Smokestone", true, "Enable Smokestone. (Add Stealth 2. +10 attack.)\n启用烟雾石（单位获得潜行 2，+10 攻击力。）");
            ...
            addMutestone = Config.Bind("General", "Mutestone", true, "Enable Mutestone. (Apply Mute 1 to all enemies.)\n启用静默石（法术获得'对本层所有敌方单位施加静默 1。'）");
            ...
            addLeechstone = Config.Bind("General", "Leechstone", true, "Enable Leechstone. (Add Lifesteal 2. +10 Attack.)\n启用水蛭石（单位获得吸血 2，+10 攻击力。）");
            ...
            addSteelstone = Config.Bind("General", "Steelstone", true, "Enable Steelstone. (Add Steelguard and Armor 50.)\n启用钢铁石（单位获得护甲 50 和钢铁护卫。）");
            ...
            if (addHealstone.Value) paths.Add("json/enhancers/soul_savior/healstone.json");
            if (addSunstone.Value) paths.Add("json/enhancers/soul_savior/sunstone.json");
            if (addVinestone.Value) paths.Add("json/enhancers/soul_savior/vinestone.json");
            if (addBackstone.Value) paths.Add("json/enhancers/soul_savior/backstone.json");
            if (addCloudstone.Value) paths.Add("json/enhancers/soul_savior/cloudstone.json");
            if (addWeakstone.Value) paths.Add("json/enhancers/soul_savior/weakstone.json");
            ...
            if (addTramplestone.Value) paths.Add("json/enhancers/soul_savior/tramplestone.json");
            if (addSwipestone.Value) paths.Add("json/enhancers/soul_savior/swipestone.json");
            if (addTrainstone.Value) paths.Add("json/enhancers/soul_savior/trainstone.json");
            if (addPiercestone.Value) paths.Add("json/enhancers/soul_savior/piercestone.json");
            ...
            if (addForgestone.Value) paths.Add("json/enhancers/soul_savior/forgestone.json");
            if (addHearthstone.Value) paths.Add("json/enhancers/soul_savior/hearthstone.json");
            if (addSmeltstone.Value) paths.Add("json/enhancers/soul_savior/smeltstone.json");
            if (addSteelstone.Value) paths.Add("json/enhancers/soul_savior/steelstone.json");
            if (addFroststone.Value) paths.Add("json/enhancers/soul_savior/froststone.json");
            if (addMeekstone.Value) paths.Add("json/enhancers/soul_savior/meekstone.json");
            if (addMutestone.Value) paths.Add("json/enhancers/soul_savior/mutestone.json");
            if (addOfferstone.Value) paths.Add("json/enhancers/soul_savior/offerstone.json");
            if (addDownstone.Value) paths.Add("json/enhancers/soul_savior/downstone.json");
            if (addGorgestone.Value) paths.Add("json/enhancers/soul_savior/gorgestone.json");
            if (addLeechstone.Value) paths.Add("json/enhancers/soul_savior/leechstone.json");
            if (addMorselstone.Value) paths.Add("json/enhancers/soul_savior/morselstone.json");
            if (addFrontstone.Value) paths.Add("json/enhancers/soul_savior/frontstone.json");
            if (addGrowstone.Value) paths.Add("json/enhancers/soul_savior/growstone.json");
            if (addPlaguestone.Value) paths.Add("json/enhancers/soul_savior/plaguestone.json");
            if (addSpawnstone.Value) paths.Add("json/enhancers/soul_savior/spawnstone.json");
            if (addEtchstone.Value) paths.Add("json/enhancers/soul_savior/etchstone.json");
            if (addFusionstone.Value) paths.Add("json/enhancers/soul_savior/fusionstone.json");
            if (addInspirestone.Value) paths.Add("json/enhancers/soul_savior/inspirestone.json");
            if (addReapstone.Value) paths.Add("json/enhancers/soul_savior/reapstone.json");
            if (addStrikestone.Value) paths.Add("json/enhancers/soul_savior/strikestone.json");
            if (addHungerstone.Value) paths.Add("json/enhancers/soul_savior/hungerstone.json");
            if (addRevengestone.Value) paths.Add("json/enhancers/soul_savior/revengestone.json");
            if (addRallystone.Value) paths.Add("json/enhancers/soul_savior/rallystone.json");
            if (addGravestone.Value) paths.Add("json/enhancers/soul_savior/gravestone.json");
